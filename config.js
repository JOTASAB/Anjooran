...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By 𝗝𝗢𝗧𝗔𝗦𝗔𝗕' : process.env.ALL_CAPTION,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? '𝗝𝗢𝗧𝗔𝗦𝗔𝗕 𝐁𝐎𝐓' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://www.pinterest.com/pin/706431891558560241/' : process.env.ALL_IMG,
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://www.instagram.com/kl_35_pala_karannn' : process.env.SOCIAL_MEDIA,
